...
class SalleController extends AbstractController
{
    ...
    public function index(SalleRepository $salleRepository,Request $request): Response
    {
        ...
        $liste= $salleRepository->findSallepaginated($page,2);
    ...
    public function new(Request $request, SalleRepository $salleRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this-> addFlash('success', 'La salle a été ajouter avec success');
        }
    ...
    public function edit(Request $request, Salle $salle, SalleRepository $salleRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_salle_liste', [], Response::HTTP_SEE_OTHER);
            $this-> addFlash('success', 'La Salle a été modifier avec succes');
        }
