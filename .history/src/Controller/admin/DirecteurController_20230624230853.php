...
class DirecteurController extends AbstractController
{
    ...
    public function update($username, Request $request, EntityManagerInterface $entityManagerInterface): Response
    {
    ...
    public function delete($username,DirecteurRepository $directeurRepository, EntityManagerInterface $entityManagerInterface): Response
    {
        $directeur= $entityManagerInterface->getRepository(Directeur::class)->find($username);
