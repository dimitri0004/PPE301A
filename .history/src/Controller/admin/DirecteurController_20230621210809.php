...
class DirecteurController extends AbstractController
{
    ...
    public function update(Directeur $directeur, Request $request, EntityManagerInterface $entityManagerInterface): Response
    {
        $form =$this->createForm(DirecteurType::class , $directeur);
        $form->handleRequest($request);
    ...
    public function delete(Directeur $directeur,DirecteurRepository $directeurRepository): Response
    {
