...
class DirecteurController extends AbstractController
{
    ...
    public function read(DirecteurRepository $directeurRepository , Request $request): Response
    {
        ...
        $classe=$directeurRepository->findDirecteurpaginated($page,2);
    ...
    #[Route('/modifier/{nom}', name: 'modifier')]
    public function update($nom, Request $request, EntityManagerInterface $entityManagerInterface): Response
    {
        $directeur= $entityManagerInterface->getRepository(Directeur::class)->find($nom);
        $form =$this->createForm(DirecteurType::class , $directeur);
        $form->handleRequest($request);
    ...
    #[Route('/supprimer/{nom}', name: 'supprimer')]
    public function delete($nom,DirecteurRepository $directeurRepository, EntityManagerInterface $entityManagerInterface): Response
    {
        $directeur= $entityManagerInterface->getRepository(Directeur::class)->find($nom);
