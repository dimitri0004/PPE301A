...
class ProffesseurController extends AbstractController
{
    ...
    public function update($id, Request $request,ProffesseurRepository $proffesseurRepository, EntityManagerInterface $entityManagerInterface): Response
    {
        $proffesseur= $proffesseurRepository->find($id);
        $form =$this->createForm(ProffesseurType::class , $proffesseur);
        $form->handleRequest($request);
        ...
        return $this->renderForm('admin/proffesseur/modifier.html.twig', [
            'form' => $form,
        ]);
    }

    #[Route('/supprimer/{id}', name: 'supprimer')]
    public function delete($id,ProffesseurRepository $proffesseurRepository, EntityManagerInterface $entityManagerInterface): Response
    {
        $proffesseur= $entityManagerInterface->getRepository(Proffesseur::class)->find($id);
