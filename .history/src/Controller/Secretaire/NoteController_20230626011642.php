...
class NoteController extends AbstractController
{
    ...
    {
        return $this->render('secretaire/note/index.html.twig', [
    ...
    public function new(Request $request, NoteRepository $NoteRepository): Response
    {
        ...
        return $this->renderForm('secretaire/note/new.html.twig', [
            'note' => $Note,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Note $Note, NoteRepository $NoteRepository): Response
    {
        ...
        return $this->renderForm('secretaire/note/edit.html.twig', [
            'note' => $Note,
            'form' => $form,
        ]);
    }
