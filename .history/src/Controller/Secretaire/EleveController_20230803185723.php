...
class EleveController extends AbstractController
{
    ...
    #[Route('modifier/{username}', name: 'modifier', methods: ['GET', 'POST'])]
...
public function delete($username,EleveRepository $eleveRepository, EntityManagerInterface $entityManagerInterface): Response
{
    $eleve= $entityManagerInterface->getRepository(Directeur::class)->find($username);
    $supprimer=$eleveRepository->remove($eleve, true);
    $this-> addFlash('success', 'Eleve a été supprimer  avec succes');
    return $this->redirectToRoute('secretaire_eleve_supprimer');
}
}
