...
class EleveController extends AbstractController
{
    ...
    public function liste(EleveRepository $eleveRepository, EntityManagerInterface $entityManager): Response
    {
        ...
        $annees = $this->$entityManager->getRepository(Annee::class)->findAll();
