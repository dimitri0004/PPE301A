...
#[Route('supprimer/{username}', name: 'supprimer', methods: ['POST'])]
public function delete(Request $request, Eleve $eleve, EleveRepository $eleveTempsRepository): Response
{
    if ($this->isCsrfTokenValid('delete'.$eeleve->getId(), $request->request->get('_token'))) {
