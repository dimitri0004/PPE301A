...
class NoteController extends AbstractController
{
    ...
    #[Route('/recuperer-eleves', name: 'recuperer_eleves', methods: ['POST'])]
    public function recupererEleves(Request $request, EleveRepository $eleveRepository): Response
    {
        ...
        foreach ($eleves as $eleve) {
            $elevesOptions .= '<option value="' . $eleve->getId() . '">' . $eleve->getEmail() . '</option>';
        }

        // Renvoyer la réponse avec les options des élèves
        return new Response($elevesOptions);
    }
