...
class NoteController extends AbstractController
{
    ...
    {
        $anneId = $request->request->get('anne');
        $classeId = $request->request->get('classe');

        // Récupérer les élèves en fonction de l'année et de la classe sélectionnées
        #dd($request);
        $eleves = $eleveRepository->findElevesByAnneeAndClasse( intval($anneId), intval($classeId));
    ...
    public function edit(Note $note,Request $request, NoteRepository $noteRepository): Response
    {
