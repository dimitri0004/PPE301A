...
class EmploiController extends AbstractController
{
    ...
    #[Route('/', name: 'liste')]
    public function index(Request $request,Salle $salle, EmploiTempsRepository $emploiTempsRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($Classe != "") {
                ...
                $emploiTemps=$emploiTempsRepository->findEmploipaginated($page,$salle->getId(),2);
            }
